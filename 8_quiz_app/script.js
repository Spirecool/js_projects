...
const quizArray = [
    {
        ...
        options: ["Espagnol", "Mandarin", "Anglais", "Français"],
        correct: "Mandarin",
    },
    {
        id: "1",
        question: "Quel est le seul continent au monde à ne pas avoir de désert ?",
        options: ["Amérique du Nord", "Asie", "Afrique", "Europe"],
        correct: "Europe",
    },
    {
        id: "2",
...
nextBtn.addEventListener(
    ...
    (displayNext = () => {
        ...
        countOfQuestion.innerHTML =
            questionCount + 1 + " de " + quizArray.length + " Question";
        //display quiz
