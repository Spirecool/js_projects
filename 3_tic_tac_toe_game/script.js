...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br> Le joueur " + span[a].dataset.player.toUpperCase() + ' a gagné !!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b> Égalité !!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
